  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onSignIn}
          className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg bg-accent-red px-4 py-3 text-sm font-semibold text-white transition hover:bg-accent-red-dark"
        >
